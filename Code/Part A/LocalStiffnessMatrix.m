...
%     psi_deriv_0 = EvalBasisDeriv(0);
%     psi_deriv_1 = EvalBasisDeriv(1);
%     
%     % Form the local element matrix for the diffusion term
%     diffusion_term = [psi_deriv_0*psi_deriv_0, psi_deriv_0*psi_deriv_1; psi_deriv_1*psi_deriv_0, psi_deriv_1*psi_deriv_1];
% end
% 
% % Multiply by the Jacobian of the element transformation
% diffusion_term = diffusion_term * msh.elem(eID).J * D;
